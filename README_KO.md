...
본 소프트웨어는 명시적이든 묵시적이든 어떠한 보증 없이 **있는 그대로** 제공됩니다.

**사전 허가가 필요합니다.** 본 소프트웨어에 대한 접근, 사용, 수정, 배포 또는 재배포(프로덕션 또는 상업적 배포 포함)에는 저작권자 / 프로젝트 유지관리자의 **사전 서면 허가**가 필요합니다. 무단 사용은 금지됩니다. 허가가 필요하면 유지관리자에게 문의하세요.

**비공식·비제휴.** 본 프로젝트는 독립적인 제3자 프로젝트이며, Polymarket, Polygon 또는 관련 법인과 **제휴·후원·스폰서·공식 관계가 없습니다**. 상표는 각 권리자에게 귀속되며 설명 또는 상호운용 목적으로만 사용됩니다.

**관할 및 적법성.** 예측 시장, 카피 트레이딩, 자동 거래, 커스터디얼 지갑 서비스 또는 이와 유사한 행위가 적용 법률에 의해 제한되거나 금지된 국가·지역, 또는 그러한 대상에 대해 본 소프트웨어를 사용·제공·운영·호스팅하거나 공개해서는 **안 됩니다**. 허가 신청 또는 사용 전에 의도한 이용이 관할 법률상 적법한지 **스스로 확인**해야 합니다. 현지 법률이 해당 활동을 허용하지 않는 경우, 해당 지역에서 본 소프트웨어를 개방·배포·제공해서는 **안 됩니다**.

**금융 조언이 아닙니다.** 본 저장소의 내용은 투자, 거래, 법률, 세무 또는 재무 조언을 구성하지 않습니다. 예측 시장 및 암호화폐 거래에는 자금 전액 손실을 포함한 중대한 손실 위험이 있습니다.

**자기 책임.** 허가를 받은 경우에도 구성과 보안(개인키, 커스터디 암호화 키, API 시크릿, 지갑 인프라 등), 컴플라이언스(해당 시 AML/KYC, 제재, 증권, 도박, 세무 등) 및 모든 결과는 본인의 책임입니다. 작성자와 기여자는 본 소프트웨어 사용으로 인한 자금·데이터·이익 손실, 손해 또는 규제상 결과에 대해 **책임지지 않습니다**.

**교육·연구 목적.** 소스 코드는 [LICENSE](LICENSE) 조건에 따라 교육 및 연구 논의 목적으로 공개될 수 있으나, 위의 허가 요건 및 관할 제한을 따릅니다. 카피 트레이딩, 커스터디얼 지갑 또는 자동 주문 실행의 프로덕션 사용은 **사전 서면 허가가 있고 적법한 경우에만** 허용됩니다.

허가가 없거나 현지 법률이 해당 활동을 허용하지 않는 경우, **본 소프트웨어를 사용하지 마세요**.
