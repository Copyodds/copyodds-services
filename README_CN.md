...
**须经授权。** 访问、使用、修改、部署或再分发本软件（包括任何生产或商业部署）须事先取得著作权人 / 项目维护方的**书面授权**。未经授权不得使用。如需授权，请联系维护方申请。

**非官方关联。** 本项目为独立的第三方项目，与 Polymarket、Polygon 或其关联方**无任何隶属、背书、赞助或官方合作关系**。相关商标归各自权利人所有，仅用于描述或互操作说明。

**管辖与合法性。** 在任何禁止或限制预测市场、跟单交易、自动交易、托管钱包服务或类似活动的国家、地区，或面向任何受禁主体时，您**不得**使用、运营、托管或以其他方式对外开放本软件。在申请授权或使用本软件前，您**须自行核实**拟开展的行为在当地是否合法。若当地法律不允许，则**不得**在该地开放、部署或向用户提供本软件。

**非投资建议。** 本仓库内容不构成任何投资、交易、法律、税务或财务建议。预测市场与加密资产交易存在重大损失风险，包括本金全部亏损的可能。

**风险自负。** 即便已获授权，您仍须自行负责配置与安全（私钥、托管加密密钥、API 密钥、钱包基础设施等）、合规（视情况包括反洗钱/KYC、制裁、证券、博彩及税务等）及全部后果。作者与贡献者**不对**因使用本软件导致的资金、数据、利润损失、损害或监管后果承担责任。

**教育与研究说明。** 源代码可在 [LICENSE](LICENSE) 约定范围内用于教育与研究讨论，但仍须遵守上述授权要求与法域限制。将跟单交易、托管钱包或自动下单用于生产环境，**仅在已获书面授权且当地法律允许**的前提下方可进行。

若您未获授权，或当地法律不允许相关活动，**请勿使用本软件**。
